    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
            ...
            <div class="h-64 bg-gray-200 overflow-hidden">
                ...
                @else
                    <div class="flex items-center justify-center h-full bg-gradient-to-br from-gray-200 to-gray-300">
            ...
            <div class="p-6">
                ...
                <p class="text-sm text-gray-500 mb-4">Год: {{ $book->year_publication }}</p>
                @endif
                
                <a href="{{ route('books.show', $book->book_id) }}" class="inline-block bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition">
                    Подробнее →
                </a>
            </div>
        </div>
