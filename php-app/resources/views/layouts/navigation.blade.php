    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                <div class="ms-3">
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 hover:text-indigo-600">Войти</a>
                    <span class="mx-2 text-gray-300">|</span>
                    <a href="{{ route('register') }}" class="text-sm text-gray-700 hover:text-indigo-600">Регистрация</a>
                </div>
                @endauth
            </div>
