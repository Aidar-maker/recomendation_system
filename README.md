...
Смотри, так как эта система представлена как дополнение к "веб приложению библиотечной системы" а точнее ее модулем рекомендации книг, она не должна быть полноценным приложением. но мне для показа преподавателю промежуточного результата нужно сделать какую-нибудь frontend оболочку для нее. так вот в чем идея. можно банально переделать наши get/post запросы "которые мы делали в json форматах запросы, если ты помнишь конечно" в более удобную оболочку, также у нас в датасете уже есть ссылки на url книu, их тоже можно добавить чтобы было видно какие книги имеются ввиду 